<button title="Eliminar" type="button" class="border-0 bg-transparent" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal{{ $modalId }}">
...
<form action="{{ $route }}" method="POST">
    @csrf
    @method('DELETE')
    <div class="modal" id="confirmDeleteModal{{ $modalId }}" tabindex="-1">
